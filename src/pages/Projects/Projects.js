    ...
    <section className="projects" id="projects">
      ...
      <div className="projects__card">
        <div className="projects__details">
          ...
          <a className="projects__button" href='https://cc-project-coffee-shop.netlify.app/' target="_blank">VIEW LIVE SITE</a>
        </div>
      ...
      <div className="projects__card">
        ...
        <div className="projects__details">
          ...
          <a className="projects__button" href='https://cc-project-brainflix.netlify.app/' target="_blank">VIEW LIVE SITE</a>
        </div>
      </div>
